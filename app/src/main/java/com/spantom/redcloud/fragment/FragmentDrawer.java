...
import com.spantom.redcloud.adapter.NavDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        navTitles = getActivity().getResources().getStringArray(R.array.list_options);
        navIcons = getActivity().getResources().obtainTypedArray(R.array.list_icons_selected);
    }
